...
function [x,t] = callCEA(P, OF, eps)
% NASA CEA - Propellente solido AP/HTPB/Al
% 69% AP, 18% Al, 13% HTPB (percentuali in massa)

warning('This function does not use OF since it''s a solid propellant AP-HTPB-Al')

    [x, t] = CEA('problem','rocket','equilibrium',... 
      'p,bar',P,'sup,ae/at',eps,...
    'react','fuel','AL(cr)',...
        'wt',16,'t,k',288,'oxid','NH4CLO4(I)', 'wt',69.6,'t,k',288,...
        'fuel','HTPB', 'wt',14,'t,k',288,'h,kj/mol',-58,...
        'C', 7.075, 'H', 10.65, 'O', 0.223, 'N', 0.063, ...
        'oxid', 'Fe3O4(cr)', 'wt',0.4,'t,k',288,'output','end');
